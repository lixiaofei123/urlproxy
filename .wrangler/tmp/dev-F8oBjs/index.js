...
// .wrangler/tmp/bundle-FIagut/checked-fetch.js
...
// .wrangler/tmp/bundle-FIagut/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-FIagut/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
import index from "./f42454fd7802e0ec3f1de2a7fda06ae9013214e1-index.html";
...
async function checkAuth(req, password) {
  ...
  if (authentication !== "") {
    if (authentication.indexOf("Basic") === 0) {
      ...
      return await src_default.verify(jwttoken, SIGN_KEY);
    }
  }
  return false;
}
